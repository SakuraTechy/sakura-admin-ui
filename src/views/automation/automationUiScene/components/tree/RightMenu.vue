<template>
  <a-menu class="right-menu">
    ...
    <a-popover
      v-model:popup-visible="popupVisible" position="right" trigger="click"
...
const emit = defineEmits<{
  ...
  (e: 'on-tree-node-click', nodeData: ProjectModuleConfigResp): void
}>()

interface Props {
  treeData: ProjectModuleConfigResp[]
}
...
const onTreeSelect: TreeInstance['onSelect'] = (selectedKeys, data) => {
  ...
  emit('on-tree-node-click', data.node as ProjectModuleConfigResp)
}
</script>
